...
public class ComponentResizer extends MouseAdapter {
    ...
    public void mouseMoved(MouseEvent e) {
        // Kiểm tra vị trí chuột so với dragInsets để biết chuột đang ở mép nào
        // Gán hướng (direction) và đặt con trỏ chuột tương ứng
    ...
    // Nếu chuột đang ở khu vực resize (có direction khác 0)
    // Ghi nhớ vị trí chuột và kích thước hiện tại của component
        if (direction == 0) {
            return;
        }
    ...
    public void mouseDragged(MouseEvent e) {
        ...
        // Tính toán lại toạ độ và kích thước component mới
        // Gọi changeBounds(...) để resize theo hướng và giới hạn
    ...
    protected void changeBounds(Component source, int direction, Rectangle bounds, Point pressed, Point current) {
        ...
        // Tính toán lại x, y, width, height tùy vào hướng kéo
        // Giới hạn bởi kích thước tối thiểu/tối đa và kích thước container
        // Gọi source.setBounds(...) để cập nhật component
        int x = bounds.x;
        int y = bounds.y;
